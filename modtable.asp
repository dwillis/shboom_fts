...
ShowFTS = Request("frmShowFTS(" & I & ")")
objRS("ShowFTS") = ShowFTS
...
<% If objRS("ShowFTS") = TRUE Then %>
        <td bgcolor="<% = thecolor %>">Y<input type="radio" name="<% = "frmShowFTS(" & J & ")" %>"  value="TRUE" checked></td><td bgcolor="#FDC0AC">N<input type="radio" name="<% = "frmShowFTS(" & J & ")" %>" value="FALSE"></td></tr>
<% Else %>
...
%>
       <tr>
        ...
        <td align="center" bgcolor="#F7ECCA">Filter <br>Results <br>Order</td>
        <td align="center" colspan="2" bgcolor="#F7ECCA">Show in <br>Calc <br>Pulldown</td>
        <td align="center" colspan="2" bgcolor="#F7ECCA">Show in <br>FTS Pulldown</td></tr>
</table>
  <p>
...
PDS = ""
PDS = "<select size =""1"" name=""SampleCalcPulldown"">"&vbCrLf
PDS = PDS & "<option value=""*"">Search All Fields</option>" & vbCrLf
...
<hr>
<h2 align="center">This is Your Drop-down Menu for Full-text Searches</h2>
<center>
<% = PDS %></center>
...
<h2 align="center">There are no fields selected for full-text searching</h2>

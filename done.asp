...
'Response.Write("Do fti is: " & objRS2("DoFTI") & "<br>")
...
If NOT fs.FileExists(TheFullPath & ProjectName & "_header.inc") Then
        ...
        sp.WriteLine("")
        sp.WriteLine("")
        sp.WriteLine("<p align=""center""><em>Developed by Tom Torok and Designed by Matt Ericson of The New York Times.<br>")
...
If objRS2("DoFTI") = "YES" Then

sp.WriteLine("<p><table>")
sp.WriteLine("<tr><td colspan=2 class=pageTitle>Search Text Fields</td></tr>")
sp.WriteLine("<tr><td colspan=2 class=instructions>Select records that contain the following:</td></tr>")
sp.WriteLine("<tr><td class=""fieldHeading"">Search Term</td>")
sp.WriteLine("<td class=""fieldHeading"">Select a Field</td></tr>")
sp.WriteLine("<tr><td align=""center""><input type=""text"" name=""frmSearchWord"" size=""35""></td>")
sp.WriteLine("<td align=""center""><select size =""1"" name=""frmSearchField"">")
sp.WriteLine("<option value=""*"">Search All Fields</option>")


rs.Filter = ""
rs.Filter = "[ShowFTS] = TRUE"
rs.Sort = "TheOrder"
...
Do While Not rs.EOf
                ...
                sp.WriteLine("<option value=""" & rs("TheField") & chr(34) & ">" & rs("TheAlias") & "</option>")
...
sp.WriteLine("")
sp.WriteLine("<hr width=""80%"" noshade size=""2"" align=""left"">")
sp.WriteLine("")




End If ' There is a FTI
...
'Response.Write("Do fti is: " & Len(objRS2("DoFTI")) & "<br>")

If objRS2("DoFTI") = "YES" Then ' There is a full-text index


sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("' xxxx new ------------------------------------------------------------------------------------------")
sp.WriteLine("SearchTerm = """" & Request(""frmSearchWord"")")
sp.WriteLine("SearchField = Request(""frmSearchField"")")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("If SearchTerm <> """" Then ' do a fts")
sp.WriteLine("")
sp.WriteLine("' set ClosePren flag to end combo where clause")
sp.WriteLine("")
sp.WriteLine("	ClosePren = TRUE")
sp.WriteLine("")
sp.WriteLine("If SearchField = """" or SearchField = ""Search All Fields"" Then")
sp.WriteLine("")
sp.WriteLine("	SearchField = ""*""")
sp.WriteLine("")
sp.WriteLine("End If")
sp.WriteLine("")
sp.WriteLine("strIn = SearchTerm")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("'If InStr(strIn, chr(34)) Then ' do something about quotes")
sp.WriteLine("	strIn = Trim(strIn)")
sp.WriteLine("	Do Until InStr(strIn, ""  "") = FALSE")
sp.WriteLine("		strIn = Replace(strIn, ""  "", "" "")")
sp.WriteLine("	Loop")
sp.WriteLine("")
sp.WriteLine("	strIn = Replace(strIn, ""'"", ""''"")")
sp.WriteLine("")
sp.WriteLine("	strIn = UCASE(strIn)")
sp.WriteLine("")
sp.WriteLine("	strIn = Replace(strIn, "" AND NOT "", "" ANDNOT "")")
sp.WriteLine("	strIn = Replace(strIn, "" OR NOT "", "" ORNOT "")			")
sp.WriteLine("")
sp.WriteLine("If InStr(strIn, chr(34)) Then ' do something about quotes")
sp.WriteLine("")
sp.WriteLine("TestForQuotes = """" & RegExpTest(chr(34), StrIn)")
sp.WriteLine("If TestForQuotes <> """" Then")
sp.WriteLine("")
sp.WriteLine("	TestForQuotes = Left(TestForQuotes, Len(TestForQuotes) - 1)")
sp.WriteLine("	Response.Write(TestForQuotes & ""<br>"")")
sp.WriteLine("	SplitTestForQuotes = Split(TestForQuotes, "","")")
sp.WriteLine("	HowMany = UBOUND(SplitTestForQuotes) + 1")
sp.WriteLine("'	Response.Write(HowMany & ""<br>"")")
sp.WriteLine("	TheMod = HowMany mod 2")
sp.WriteLine("'	Response.Write(TheMod & ""<br>"")")
sp.WriteLine("")
sp.WriteLine("	If TheMod = 1 then")
sp.WriteLine("		Response.Write(""Snake Eyes"")")
sp.WriteLine("	End If")
sp.WriteLine("")
sp.WriteLine("	Redim QuoteStuff((HowMany / 2) + 1)")
sp.WriteLine("	")
sp.WriteLine("	J = 0")
sp.WriteLine("	For I = 0 to HowMany-1 Step 2")
sp.WriteLine("		J = J + 1")
sp.WriteLine("		QuoteStuff(J) = Mid(strIn, SplitTestForQuotes(I) + 2, SplitTestForQuotes(I+1) - SplitTestForQuotes(I) - 1)")
sp.WriteLine("		If InStr(QuoteStuff(J), "" "") Then")
sp.WriteLine("			QuoteStuff(J) = ""|"" & Replace(QuoteStuff(J), "" "", ""^"") & ""|""")
sp.WriteLine("		Else")
sp.WriteLine("			QuoteStuff(J) = "" "" & QuoteStuff(J) & "" """)
sp.WriteLine("		End If")
sp.WriteLine("		'	Response.Write(QuoteStuff(J) & ""<br>"")		")
sp.WriteLine("")
sp.WriteLine("	Next")
sp.WriteLine("")
sp.WriteLine("'SearchStringCopy = SearchString")
sp.WriteLine("")
sp.WriteLine("	J = 0")
sp.WriteLine("	For I = 0 to HowMany-1 Step 2")
sp.WriteLine("		J=J+1")
sp.WriteLine("		If I = 0 Then")
sp.WriteLine("			If SplitTestForQuotes(I) = 0 Then")
sp.WriteLine("				strIn = QuoteStuff(J) & Right(strIn, Len(strIn) - (SplitTestForQuotes(I + 1) + 1))")
sp.WriteLine("			Else")
sp.WriteLine("				strIn = Left(strIn, SplitTestForQuotes(I)) & QuoteStuff(J) & Right(strIn, Len(strIn) - (SplitTestForQuotes(I+1) + 1))")
sp.WriteLine("			End If		")
sp.WriteLine("")
sp.WriteLine("		Else")
sp.WriteLine("")
...
sp.WriteLine("")
sp.WriteLine("	Next")
sp.WriteLine("'	Response.Write(SearchStringCopy & ""<br>"")")
sp.WriteLine("'	Response.Write(SearchString & ""<br>"")")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("'strIn = SearchString")
sp.WriteLine("End If")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("")
...
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("End If ' do something about quotes")
sp.WriteLine("")
sp.WriteLine("	SplitString = Split(strIn, "" "")")
sp.WriteLine("	HowMany = UBound(SplitString)")
sp.WriteLine("")
sp.WriteLine("	If HowMany > 0 Then ' more than one word")
sp.WriteLine("")
'sp.WriteLine("		TheWhere = "" where """)
sp.WriteLine("		TheWhere = ""  """)
sp.WriteLine("")
sp.WriteLine("		For I = 0 To HowMany")
sp.WriteLine("")
sp.WriteLine("			Select Case SplitString(I)")
sp.WriteLine("				Case ""NOT""")
sp.WriteLine("					TheWhere = TheWhere & "" NOT """)
sp.WriteLine("				Case ""AND""")
sp.WriteLine("					TheWhere = TheWhere & "" AND """)
sp.WriteLine("				Case ""ANDNOT""")
sp.WriteLine("					TheWhere = TheWhere & "" AND NOT """)
sp.WriteLine("				CASE ""ORNOT""")
sp.WriteLine("					TheWhere = TheWhere & "" OR NOT """)
sp.WriteLine("				Case ""OR""")
sp.WriteLine("					TheWhere = TheWhere & ""  OR """)
sp.WriteLine("				Case Else")
sp.WriteLine("")
sp.WriteLine("					If Right(SplitString(I), 1) = ""*"" Then ' there is a wildcard")
sp.WriteLine("					Select Case Right(TheWhere, 5)")
sp.WriteLine("						Case "" NOT "", "" AND "", ""  OR """)
sp.WriteLine("							TheWhere = TheWhere & "" (contains("" & SearchField & "",'"" & chr(34) & SplitString(I) & chr(34) & ""'))""")
sp.WriteLine("						Case Else")
sp.WriteLine("							If I <> 0 Then")
sp.WriteLine("								TheWhere = TheWhere & "" AND "" &  "" (contains("" & SearchField & "",'"" & chr(34) & SplitString(I) & chr(34) & ""'))""")
sp.WriteLine("							Else")
sp.WriteLine("								TheWhere = TheWhere &  "" (contains("" & SearchField & "",'"" & chr(34) & SplitString(I) & chr(34) & ""'))""")
sp.WriteLine("							End If")
sp.WriteLine("					End Select")
sp.WriteLine("")
sp.WriteLine("					ElseIf Left(SplitString(I), 1) = ""|"" Then ' there is a quoted phrase")
sp.WriteLine("					SplitString(I) = Replace(SplitString(I), ""|"", chr(34))")
sp.WriteLine("					SplitString(I) = Replace(SplitString(I), ""^"", "" "")")
sp.WriteLine("					Select Case Right(TheWhere, 5)")
sp.WriteLine("						Case "" NOT "", "" AND "", ""  OR """)
sp.WriteLine("							TheWhere = TheWhere & "" (contains("" & SearchField & "",'"" & SplitString(I) & ""'))""")
sp.WriteLine("						Case Else")
sp.WriteLine("							If I <> 0 Then")
sp.WriteLine("								TheWhere = TheWhere & "" AND "" &  "" (contains("" & SearchField & "",'"" & SplitString(I) & ""'))""")
sp.WriteLine("							Else")
sp.WriteLine("								TheWhere = TheWhere &  "" (contains("" & SearchField & "",'"" & SplitString(I) & ""'))""")
sp.WriteLine("							End If")
sp.WriteLine("					End Select")
sp.WriteLine("					' End If ' end quoted phrase")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("					Else ' there is no wildcard")
sp.WriteLine("					Select Case Right(TheWhere, 5)")
sp.WriteLine("						Case "" NOT "", "" AND "", ""  OR """)
sp.WriteLine("							TheWhere = TheWhere & "" (contains("" & SearchField & "",'"" & SplitString(I) & ""'))""")
sp.WriteLine("						Case Else")
...
sp.WriteLine("							End If")
sp.WriteLine("					End Select")
sp.WriteLine("					End If ' end wildcard")
sp.WriteLine("			End Select")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("		Next")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("	Else ' there is only one word")
sp.WriteLine("		' test for an asterisk")
sp.WriteLine("		If Right(strIn, 1) = ""*"" then")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("")
'sp.WriteLine("			TheWhere = "" where contains("" & SearchField & "", '"" & chr(34) & strIn & Chr(34) & ""')""")
sp.WriteLine("			TheWhere = "" contains("" & SearchField & "", '"" & chr(34) & strIn & Chr(34) & ""')""")
sp.WriteLine("		Else")
sp.WriteLine("			IF Left(strIn, 1) = ""|"" Then ' there is a quoted phrase")
sp.WriteLine("				strIn = Replace(strIn, ""|"", chr(34))")
sp.WriteLine("				strIn = Replace(strIn, ""^"", "" "")")
sp.WriteLine("			End If")
sp.WriteLine("")
'sp.WriteLine("			TheWhere = "" where contains("" & SearchField & "", '"" & strIn & ""')""")
sp.WriteLine("			TheWhere = "" contains("" & SearchField & "", '"" & strIn & ""')""")
sp.WriteLine("		End If")
sp.WriteLine("	End If ' more than one word")
sp.WriteLine("")
sp.WriteLine("If InStr(TheWhere, chr(39) & chr(34)) Then")
sp.WriteLine("	Thewhere = Replace(TheWhere, chr(39) & chr(34), chr(39) & "" "" & chr(34))")
sp.WriteLine("	TheWhere = Replace(TheWhere, chr(34) & chr(39), chr(34) & "" "" & chr(39))")
sp.WriteLine("End If")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("'TheWhere = Replace(TheWhere, chr(39), chr(34) & "" + "" & chr(39) & chr(34))")
...
sp.WriteLine("")
sp.WriteLine("")
'sp.WriteLine("ftssqlWhere = TheWhere")
sp.WriteLine(("ftssqlWhere = "" Where ("" & TheWhere & "")"""))
' xxxx sp.WriteLine("response.write(""SqlWhere is: "" & sqlWhere & ""<br>"")")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("End If ' end query for fts")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("' ----------------------------------------------------------- end new")
sp.WriteLine("")
sp.WriteLine("'Test to see if the full-text search term is the only input")
sp.WriteLine("If Request(""frmSource"").Count <> 0 Then")
sp.WriteLine("")


End If ' End of insertion for full text index
...
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("'--------------------------------------------------------------new new")
sp.WriteLine("Else ' the only input is full text from outside the form")
sp.WriteLine("' make an sqlwhere for no input from TheSource")
sp.WriteLine("")
sp.WriteLine("sqlWhere = "" WHERE""")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("End If ' end test for input of frmTheSource")
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("")
...
sp.WriteLine("")
sp.WriteLine("If len(sqlWhere) = 6 Then")
sp.WriteLine("	sqlWhere = ftssqlWhere")
sp.WriteLine("Elseif len(ftssqlWhere) > 0 Then")
sp.WriteLine("'	sqlWhere = Replace(sqlWhere, ""WHERE "", """")")
sp.WriteLine("	sqlWhere = Right(sqlWhere, Len(sqlwhere) - 5)")
sp.WriteLine("	sqlWhere = ftssqlWhere & "" AND ("" & sqlWhere & "")""")
sp.WriteLine("End If")
sp.WriteLine("")


End If '--------------------------------------------------------There is a full text index
...
' ------------------------------------------new for fts
' this is necessary because the quote marks for fts can mess up the hidden tag for sql

If objRS2("DoFTI") = "YES" Then
	sp.WriteLine("sql = Replace(sql, ""@@@"", chr(34))")
End If
...
' insert script to enable double-click links
...
sp.WriteLine("<script>")
sp.WriteLine("	")
sp.WriteLine("    var gaga;function selectMe() {")
sp.WriteLine("    var r=document.body.createTextRange();")
sp.WriteLine("    r.moveToPoint(window.event.x, window.event.y);")
sp.WriteLine("    r.expand(""word"");")
sp.WriteLine("	r.select();")
sp.WriteLine("	gaga=r.text;")
sp.WriteLine("	var ralph=gaga")
sp.WriteLine("	var re = / /g;")
sp.WriteLine("	gaga = gaga.replace(re, """");")
sp.WriteLine("	r.pasteHTML(""<a href='"" + document.profile.makelink.value + ""?frmSearchWord="" + gaga + ""'>"" + ralph + ""</a>"")	")
sp.WriteLine("   }")


' see if there is a project include and write script for same


	If objRS2("pkgInclude") <> "" Then

		sp.WriteLine("")
		sp.WriteLine("	function checkProfile() {")
		sp.WriteLine("	document.profile.action=document.profile.makelink.value;")
		sp.WriteLine("")
		sp.WriteLine("   }")
		sp.WriteLine("")


	End if ' package include
sp.WriteLine("</script>")
End If ' script for double click


sp.WriteLine("</HEAD>")

' include proper body tag for FTS

If objRS2("HasFTI") then 
	sp.WriteLine("<body bgcolor=""white""  id=myH1 ondblclick=selectMe()>")
Else
	sp.WriteLine("<body bgcolor=""white"">")
End If ' body tag for fti

sp.WriteLine("<!" & "--#include file = """ & ProjectName & "_links.inc"" -->")
sp.WriteLine("<!" & "--#include file = """ & ProjectName & "_header.inc"" -->")
' see if there's an include file for a package
IF objRS2("DoFTI") = "YES" and objRS2("pkgInclude") <> "" Then
	sp.WriteLine("<!" & "--#include virtual = """ & objRS2("pkgInclude") & """ -->")
End IF
...
' ------------------------- New for XLS ---------------------------------------------
sp.WriteLine(Chr(60) + Chr(37))
sp.WriteLine("Sql = Replace(Sql, "" WHERE "", "" Where "")") 
sp.WriteLine("	SplitWhere = Split(Sql, "" Where "")")
sp.WriteLine("  If UBound(SplitWhere) > 0 Then")
sp.WriteLine("		XLSWhere = SplitWhere(1)")
sp.WriteLine("  Else")
sp.WriteLine("		XLSWhere = " & chr(34) & Chr(34))
sp.WriteLine("  End If")
sp.WriteLine("If RS.RecordCount <= 5000 Then")
sp.WriteLine("")
sp.WriteLine(Chr(37) & ">")
sp.WriteLine("")

sp.WriteLine("<center><small><b>Click <a href=""" & ProjectName & "_output.asp?XLSWhere=<" & chr(37) & " = server.urlencode(XLSWhere) " & chr(37) & ">"" target=""_blank"">here</a> to view these results in a spreadsheet.</b> (<a href=""/help/spreadhelp.asp"" target=""_blank"">Help</a> on this.)</small></center>")
sp.WriteLine("")
sp.WriteLine("<" & chr(37) & " Else " & Chr(37) & ">")


sp.WriteLine("<center><small><b>Click <a href=""" & ProjectName & "_delimited.asp?XLSWhere=<" & chr(37) & " = server.urlencode(XLSWhere) " & chr(37) & ">"" target=""_blank"">here</a> to view these results in comma-separated values.</b> (<a href=""/help/csvhelp.asp"" target=""_blank"">Help</a> on this.)</small></center>")
...
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("Function RegExpTest(patrn, strng)")
sp.WriteLine("   Dim regEx, Match, Matches   ' Create variable.")
sp.WriteLine("   Set regEx = New RegExp   ' Create a regular expression.")
sp.WriteLine("   regEx.Pattern = patrn   ' Set pattern.")
sp.WriteLine("   regEx.IgnoreCase = True   ' Set case insensitivity.")
sp.WriteLine("   regEx.Global = True   ' Set global applicability.")
sp.WriteLine("   Set Matches = regEx.Execute(strng)   ' Execute search.")
sp.WriteLine("   For Each Match in Matches   ' Iterate Matches collection.")
sp.WriteLine("      RetStr = RetStr & Match.FirstIndex & "",""")
sp.WriteLine("   Next")
sp.WriteLine("   RegExpTest = RetStr")
sp.WriteLine("End Function")
sp.WriteLine("")
sp.WriteLine("")
...
' write the _output.asp page
Set sp = fs.CreateTextFile(TheFullPath & ProjectName & "_output.asp", True)
...
sp.WriteLine("Const adCmdFile = &H0100")
sp.WriteLine("Const adCmdTableDirect = &H0200")
' ----------------------------- Add for group by or calculations ------------------------
sp.WriteLine("If Request.QueryString(""XLSWhere"") <> " & chr(34) & chr(34) & " Then")
' ----------------------------- Add for group by or calculations ------------------------
sp.WriteLine("		XLSWhere = " & chr(34) & chr(34) & " & Request(""XLSWhere"")")
sp.WriteLine("		XLSWhere = Replace(XLSWhere, ""@@@"", chr(34))")
...
XLSSelect = "Set textsize 32767 Select "
...
For P = 1 to RS.RecordCount
	...
	If P <> RS.RecordCount Then
		...
		XLSSelect = XLSSelect & rs("TheField") & " AS [" & rs("TheAlias") & "], "
...
XLSSelect = XLSSelect & "from " & objRS2("TheTable")

sp.WriteLine("		XLSSelect = " & chr(34) & XLSSelect & " " & chr(34))
sp.WriteLine("		If XLSWhere <> " & chr(34) & Chr(34) & " Then ")
sp.WriteLine("          		sql = XLSSelect & "" Where "" &  XLSWhere")
sp.WriteLine("		Else")
sp.WriteLine("          		sql = XLSSelect")
sp.WriteLine("		End If")
' ----------------------------- Add for group by or calculations ------------------------

sp.WriteLine("Else ' the query string is a sql statement")
sp.WriteLine("		sql=Request(""sql"")")
sp.WriteLine("End If ' End test for querystring")
sp.WriteLine("Response.ContentType = ""application/vnd.ms-excel" & chr(34))





' ----------------------------- End Add for group by or calculations ------------------------
...
sp.WriteLine("<TR>")
sp.WriteLine("<" & chr(37) & " For i = 0 to RS.Fields.Count - 1 " & chr(37) & ">")
sp.WriteLine("	<TD><B><" & chr(37) & " = RS(i).Name " & chr(37) & "></B></TD>")
sp.WriteLine("<" & chr(37) & " Next " & chr(37) & ">")
sp.WriteLine("</TR>")
sp.WriteLine("<" & chr(37) & " Do While Not RS.EOF " & chr(37) & ">")
sp.WriteLine("	<TR>")
sp.WriteLine("	<" & chr(37) & " For i = 0 to RS.Fields.Count - 1 ")
sp.WriteLine("		Select Case RS(i).Type")
sp.WriteLine("			Case 129, 130, 200, 201, 202, 203 " & chr(37) & ">")
sp.WriteLine("				<TD VALIGN=TOP>=""<" & chr(37) & " = RS(i) " & chr(37) & ">""</TD>")
sp.WriteLine("<" & chr(37))
sp.WriteLine("			Case Else")
sp.WriteLine("" & chr(37) & ">")
sp.WriteLine("				<TD VALIGN=TOP><" & chr(37) & " = RS(i) " & chr(37) & "></TD>")
...
' write the _delimited.asp page
Set sp = fs.CreateTextFile(TheFullPath & ProjectName & "_delimited.asp", True)
...
sp.WriteLine("XLSWhere = " & chr(34) & chr(34) & " & Request(""XLSWhere"")")
sp.WriteLine("XLSWhere = Replace(XLSWhere, ""@@@"", chr(34))")
sp.WriteLine("Response.ContentType = ""text/plain" & chr(34))
...
sp.WriteLine("")
sp.WriteLine("")
sp.WriteLine("XLSHeader = """"")
sp.WriteLine("")
sp.WriteLine("For i = 0 to rs.Fields.Count - 1")
sp.WriteLine("")
sp.WriteLine("	If I <> rs.Fields.Count - 1 Then")
sp.WriteLine("		XLSHeader = XLSHeader & chr(34) & rs(I).Name & chr(34) & "",""")
sp.WriteLine("")
sp.WriteLine("	Else")
sp.WriteLine("		XLSHeader = XLSHeader & chr(34) & rs(I).Name & chr(34)")
sp.WriteLine("	End If")
...
sp.WriteLine("Next")
sp.WriteLine("")
sp.WriteLine("XLSHeader = XLSHeader & vbCRLF")
sp.WriteLine(Chr(37) & ">")
sp.WriteLine("<" & Chr(37) & " = XLSHeader " & chr(37) & ">")
sp.WriteLine("<" & chr(37))
sp.WriteLine("Do While Not RS.EOF ")
sp.WriteLine("TheLine = """"")
sp.WriteLine("	For i = 0 to RS.Fields.Count - 1 ")
sp.WriteLine("")
sp.WriteLine("		Select Case RS(i).Type")
sp.WriteLine("			Case 129, 130, 200, 201, 202, 203 ")
sp.WriteLine("				FieldValue = """" & RS(i)")
sp.WriteLine("				FieldValue = Replace(FieldValue, chr(34), chr(34) & chr(34))")
sp.WriteLine("				TheLine = TheLine & chr(34) & FieldValue & chr(34) & "",""")
sp.WriteLine("			Case Else")
sp.WriteLine("				TheLine = TheLine & rs(i) & "",""")
sp.WriteLine("")
sp.WriteLine("		End Select")
sp.WriteLine("	Next ")
sp.WriteLine("	TheLine = Left(TheLine, Len(TheLine) - 1) & vbCRLF")
sp.WriteLine("	")
sp.WriteLine("")
sp.WriteLine("'	Response.Write(TheLine)")
sp.WriteLine(Chr(37) & ">")
sp.WriteLine("")
sp.WriteLine("<" & Chr(37) & " = TheLine " & chr(37) & ">")
sp.WriteLine("")
sp.WriteLine("<" & Chr(37))
sp.WriteLine("")
sp.WriteLine("	RS.MoveNext")
...
sp.WriteLine("<center><small><b>Click <a href=""" & ProjectName & "_output.asp?XLSWhere=<" & chr(37) & " = server.urlencode(XLSWhere) " & chr(37) & ">"" target=""_blank"">here</a> to view these results in a spreadsheet.</b></small></center>")
sp.WriteLine("")
sp.WriteLine("<" & chr(37) & " Else " & Chr(37) & ">")


sp.WriteLine("<center><small><b>Click <a href=""" & ProjectName & "_delimited.asp?XLSWhere=<" & chr(37) & " = server.urlencode(XLSWhere) " & chr(37) & ">"" target=""_blank"">here</a> to view these results in comma-separated values.</b></small></center>")
...
' --------------------------- NEW FOR OUTPUT TO SPREADSHEET -----------------------------------------
sp.WriteLine("<center><small><b>Click <a href=""" & ProjectName & "_output.asp?sql=<" & chr(37) & " = server.urlencode(sql) " & chr(37) & ">"" target=""_blank"">here</a> to view these results in a spreadsheet.</b> (<a href=""/help/outputhelp.asp"" target=""_blank"">Help</a> on this.)</small></center>")
' --------------------------- END NEW FOR OUTPUT TO SPREADSHEET -------------------------------------
...
sp.WriteLine "tb.AddTab ""hom"", ""default.asp"", ""Home"""
...
If objRS2("AllowUserMod") = "YES" Then
        'sp.WriteLine(" | <a href=""/shboomfts/modify.asp?TheFullPath=" & Server.URLEncode(TheFullPath) & "&ProjectName="& ProjectName & Chr(34) & ">Modify</a>")
        sp.WriteLine "tb.AddTab ""modify"", ""/shboomfts/modify.asp?TheFullPath=" & Server.URLEncode(TheFullPath) & "&ProjectName="& ProjectName & """, ""Modify"""
...
' --------------------------------------------- NEW FOR SPREADSHEET RESULTS --------------------------------
sp.WriteLine("<center><small><b>Click <a href=""" & ProjectName & "_output.asp?sql=<" & chr(37) & " = server.urlencode(sql) " & chr(37) & ">"" target=""_blank"">here</a> to view these results in a spreadsheet.</b> (<a href=""/help/outputhelp.asp"" target=""_blank"">Help</a> on this.)</small></center>")
' ---------------------------------------------  END NEW FOR SPREADSHEET RESULTS ---------------------------
...
sp.WriteLine(TheLine)
TheLine = "<tr><td class=detailsHeading>" & rs("TheAlias") & ": </td><td class=detailsData>" & Chr(60) & Chr(37) & " = Punct(str" & rs("TheField")  & ") " & chr(37) + "></td></tr>"
sp.WriteLine(TheLine)
...
sp.WriteLine("Function Punct(strfield)")

sp.WriteLine("Punct = strField")

sp.WriteLine("If InStr(Punct, chr(9)) Then ")
sp.WriteLine("        Punct=Replace(Punct, chr(9), " & chr(34) & "&nbsp;&nbsp;&nbsp" & chr(34) & ")")
sp.WriteLine("End If")
sp.WriteLine(" ")
sp.WriteLine("If InStr(Punct, chr(13)) Then ")
sp.WriteLine("        Punct=Replace(Punct, chr(13), " & chr(34) & "<br>" & chr(34) & ")")
sp.WriteLine("End If")
...
<center><i>Shboom was developed by Tom Torok and Designed by Matt Ericson of The New York Times</i></center>

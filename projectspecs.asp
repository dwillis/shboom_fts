...
sql = "exec sp_help_fulltext_columns " & TheTable
...
RS.Close
response.Write("Is there full text index? " & HasFTI)
...
On Error Resume Next 
 ...
 ' If the file does not exist we will get error no 3709
  If err.number = 3709 Then
    ...
    objRS.Fields.Append "HasFTI", adBoolean
    objRS.Fields.Append "DoFTI", adVarChar, 3
    objRS.Fields.Append "pkgInclude", adVarChar, 150
...
<INPUT TYPE="HIDDEN" NAME="HasFTI" VALUE="<% = HasFTI %>">
...
<% If HasFTI = True Then %>
      ...
      <tr>
        <td align="right"><b>Enable Full-text searching on this table <a href="#FTI">(H)</a>
</td></b>
        <td><b><select size="1" name="frmDoFTI">
            <option value="NO">No</option>
            <option selected value="YES">Yes</option>
          </select></td></b>
      </tr>
      <tr>
        <td align="right"><b><i>Virtual</i> path and name of include file for packages.  (e.g. /thetimes/campaign_pkg.inc)<a href="#pkg">(H)</a></td></b>
        <td><b><input type="text" name="frmpkgInclude" size="75"></td></b>
      </tr>
      <tr>
...
<INPUT TYPE="HIDDEN" NAME="frmDoFTI" VALUE="<% = objRS("DoFTI") %>">
<INPUT TYPE="HIDDEN" NAME="frmpkgInclude" VALUE="">
...
<% IF HasFTI = TRUE Then %>
<p align="left"><b><a name="FTI">Full-text </a>index.</b></p>
If your table has a full-text
Index, you are offered the option of enabling full-text features. These include a 
full-text search box on the filter page and the ability to generate links to search
within the table by double clicking on any word on results pages.</p>
<p align="left"><b><a name="pkg">Package Include</a></b></p>
If you enter the virtual path and name of an 
include file for packages, the program will place includes and write code on appropriate pages
to allow the user to select a data store from a pull-down menu then launch a search 
in the respective store, either from the input box or by double clicking on a word.
You can find a sample include, testpkg.inc, in this folder.
</p>
<% End IF %>
</body>
